          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="text-white bg-red-600 hover:bg-red-500 rounded-xl w-10 h-10 flex items-center justify-center ease-in-out duration-300"
              >
                <FiLogOut />
              </button>
            </>
            ...
            <button
              onClick={handleLogin}
              className="text-white bg-zinc-800 hover:bg-zinc-700 rounded-xl w-10 h-10 flex items-center justify-center ease-in-out duration-300"
            >
              <FaUserAlt />
            </button>
          )}
